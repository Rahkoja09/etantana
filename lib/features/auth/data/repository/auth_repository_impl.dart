...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Stream<AuthEntity?> onAuthStateChanged() => _remoteSource.onAuthStateChanged();
  ...
  @override
  ResultFuture<AuthEntity?> signInWithGoogle({required String webId, String? iosId}) async {
    return await _execute(() => _remoteSource.signInWithGoogle(webId: webId, iosId: iosId));
  }
