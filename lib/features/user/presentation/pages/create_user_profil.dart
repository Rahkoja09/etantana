...
class _CreateUserProfilState extends ConsumerState<CreateUserProfil> {
  ...
  Widget build(BuildContext context) {
    ...
    // Dans AppShell.build()
    ref.listen<UserStates>(userControllerProvider, (prev, next) async {
      if (next.users != null && next.isLoading == false) {
          ...
          MaterialPageRoute(
            builder:
                (_) => CongratulationPage(
                  ...
                  title: "Profil créée !",
                  subtitle: "Votre profil est prêt pour les prochains activité",
                  note: "Vous pouvez modifier les informations à tout moment.",
                  primaryLabel: "Voir mon profil",
                  onPrimary: () => context.push("/profil"),
